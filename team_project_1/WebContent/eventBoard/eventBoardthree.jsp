	...
	<div class="container">
		<div class="wrapper">
			...
			<div class="a_btn">
				...
				<br>
				<div>
				<div id="img" style="background: url('images/event15.JPG'); width: 646px; height: 519px; background-size: auto;"></div>
				<div id="img" style="background: url('images/event16.JPG'); width: 646px; height: 804px; background-size: auto;"></div>
				<div id="img" style="background: url('images/event17.JPG'); width: 646px; height: 241px; background-size: auto;"></div>
				</div>
